...
class obtenerRepPorFechaCategoria extends controllerExtended {
  ...
  public function main(\request $request) {
    try {
      ...
      $respuesta1 = $controlDAO->reportePorFechaCategoria($request->getParam('fechaInicialC'), $request->getParam('fechaFinalC'), $request->getParam('categoria') );
      $respuesta2 = array(
